...
defmodule CollaborationWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh,
    view: CollaborationWeb.Coherence.EmailView,
    layout: {CollaborationWeb.Coherence.LayoutView, :email}
  ...
  def password(user, url) do
    ...
    |> subject(
      dgettext(
        "coherence",
        "%{site_name} - Reset password instructions",
        site_name: site_name()
      )
    )
